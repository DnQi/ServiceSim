...
public class CompAllUpdateDevicesProvider1 extends DevicesProvider {
    ...
    public CompAllUpdateDevicesProvider1(int nodeNum) {
        super();
    ...
    public void createDevices(){
        ...
        for (int i = 0;i<smallBS_devices.size();i++){
            ...
            Channel channel = new Channel(smallBS_devices.get(i).getId(),router.get(0).getId(),13 * 1024 * 1024,0.0002,new PacketSchedulerTimeShared());
            ...
            Channel channel1 = new Channel(router.get(0).getId(),smallBS_devices.get(i).getId(),13 * 1024 * 1024,0.0002,new PacketSchedulerTimeShared());
